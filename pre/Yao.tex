...
\begin{frame}{Discussion}
    \begin{itemize}
        ...
        \vspace{0.2cm}
        \item Double-descent: by increase the number of parameters, we can both fit the data perfectly and achieve outstanding generalization. The cure to over-fitting is to add more parameters.
        \vspace{0.2cm}
        \item While normally we think of a high-dimensional state space as making integrals more difficult, a large number of shocks make expectations easier to calculate by concentration of measure.
        \vspace{0.2cm}
        \item Using stochastic optimization methods with highly overparameterized models tends to robustly find solutions that fulfill a minimum norm solution in the space of approximating functions.(ADAM)
    \end{itemize}
\end{frame}
\end{document}